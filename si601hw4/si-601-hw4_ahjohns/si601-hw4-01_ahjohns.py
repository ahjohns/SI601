...
##I used Danny's foundation code from his example to get the facebook data and open the url,
## and to iterate through the friends data with the accesstoken.
## All other work is my own, however I worked with Elizabeth Kunze to talk about varying approaches
## to getting the data from the json string, and hints on how to manipulate the database with SQL.
